...
//  Sections
//
//  Created by Aaron Dougher on 3/4/18.
        ...
        if let searchString = searchController.searchBar.text {
            ...
            if !searchString.isEmpty {
                let filter: (String) -> Bool = {
                    ...
                    if (buttonIndex == SearchResultsControllerTableViewController.shortNameButtonIndex && nameLength >= SearchResultsControllerTableViewController.longNameSize) || (buttonIndex == SearchResultsControllerTableViewController.longNamesButtonIndex && nameLength < SearchResultsControllerTableViewController.longNameSize){
                        return false
                    }
